...
def test_thresh(img, lower_thresh, upper_thresh):
    thresh = threshold(img, lower_thresh, upper_thresh)
...
def setupCamera():
    ...
    camera = "head_camera"
    window_name = "Head Camera Window"
...
if __name__ == '__main__':
    ...
    #test_thresh(test_img, 0, 255)
    #threshold(IMG_DIR + '/IMG-1115.jpg', 'BLUE')
    setupCamera()
